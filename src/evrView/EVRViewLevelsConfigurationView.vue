<template>
  <div class="c-inspect-properties">
    <template v-if="isEditing">
      <div class="c-inspect-properties__header">EVR Levels</div>
      <ul class="c-inspect-properties__section">
        <li v-for="(isEnabled, key) in levels" :key="key" class="c-inspect-properties__row">
          <div class="c-inspect-properties__label" :title="key">
            <label :for="key" :style="levelsStyles[key]">
              {{ key }}
            </label>
          </div>
  ...
  computed: {
    levels() {
      const existingLevels =
        this.domainObject.configuration && this.domainObject.configuration.levels;
