<template>
  <div class="l-venue-section l-active-session-selector" :class="{ loading: loading }">
    <div v-if="!topics.length" class="blank">
        ...
        <ul class="c-tree l-topics-tree">
          <li v-for="topic in topics" :key="topic.model.id" class="c-tree__item-h">
            ...
            <span class="c-tree__item__subtree" v-if="topic.expanded">
              <ul class="c-tree">
                <li v-for="session in topic.model.sessions" :key="session.id" class="c-tree__item-h">
                  <span class="c-tree__item" :class="{'is-selected': isSelected(session)}" @click="selectSession(session)">
