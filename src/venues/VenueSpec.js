...
describe('Venue', () => {
    ...
    it('returns a domain object', () => {
        ...
        expect(domainObject.channelEnumerationDictionaryUrl).toBe(configuration.channelEnumerationDictionaryUrl);
        ...
        expect(domainObject.packetSummaryEventStreamUrl).toBe(configuration.packetSummaryEventStreamUrl);
