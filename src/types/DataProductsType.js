...
import * as stringUtils from 'ommUtils/strings.js';
 ...
 */
const DataProductsType = new VISTAType({
  ...
  makeObject: function (dataset, data) {
    return Promise.resolve({
      ...
      telemetry: {
        ...
        dataProductContentUrl: fullyQualifiedURL(
          dataset.options.dataProductContentUrl,
          dataset.options.mcwsRootUrl
        ),
...
export default DataProductsType;
