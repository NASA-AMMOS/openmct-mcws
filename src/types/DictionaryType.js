define(['./VISTAType', './DictionarySourceType'], function (VISTAType, DictionarySourceType) {
  /**
  ...
  var DictionaryType = new VISTAType({
    ...
    getLocation: function (dataset, data) {
      return DictionarySourceType.makeIdentifier(data.datasetIdentifier);
    },
    ...
    makeObject: function (dataset, data) {
      return VISTAType.prototype.makeObject.apply(this, arguments).then(function (object) {
