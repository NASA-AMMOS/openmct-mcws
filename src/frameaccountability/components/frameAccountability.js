import FrameAccountabilityTemplate from './res/frameAccountability.html';
import frameAccountabilityNode from './frameAccountabilityNode.js';
import frameAccountabilityBadFrames from './frameAccountabilityBadFrames.vue';
import SortedEventsCollection from '../sortedEventsCollection.js';
...
export default {
  ...
  components: {
    ...
    frameAccountabilityBadFrames: frameAccountabilityBadFrames
  },
  data() {
    return {
      vcids: [],
  ...
  methods: {
    ...
    createEventsCollection(vcid) {
      const collection = new SortedEventsCollection();
    ...
    updateFramesCollection(vcid) {
      return (datum) => {
        ...
        this.events[vcid] =
          this.events[vcid] !== undefined ? collection.getRows() : [collection.getRows()];
      };
    },
    lastChild(vcid) {
