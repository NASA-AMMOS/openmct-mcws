  ...
  <div class="u-contents">
    ...
    <template v-else>
      ...
      <div class="c-overlay__dialog-hint">
        <span v-if="topics.length">Select a topic or session</span>
        <span v-else>No topics are currently available</span>
      </div>
        ...
        <ul class="c-tree l-topics-tree">
          <li v-for="(topic, index) in topics" :key="index" class="c-tree__item-h">
            <div class="c-tree__item" :class="{ 'is-selected': topic.selected }">
              ...
              <div class="c-object-label c-tree__item__label" @click="select(topic)">
