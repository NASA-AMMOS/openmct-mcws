...
describe('The Data Product Row', () => {
  ...
  it('Sets received parts to 0 when start message received', () => {
    dataProductRow = new DataProductRow(
      startMessage,
      columns,
      objectKeyString,
      limitEvaluator,
  ...
  it('Increments part count when product part message received', () => {
    dataProductRow = new DataProductRow(
      startMessage,
      columns,
      objectKeyString,
  ...
  it('Does not replace content of complete rows with in progress rows', () => {
    dataProductRow = new DataProductRow(
      startMessage,
      columns,
      objectKeyString,
