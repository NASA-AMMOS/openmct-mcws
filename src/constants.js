define([], function () {
  var CONSTANTS = {
     ...
     */
    CHANNEL_PROPERTIES: ['channelDictionaryUrl'],
     ...
     */
    DATA_PRODUCT_PROPERTIES: ['dataProductUrl', 'dataProductContentUrl'],

    /**
     * An array of model properties that provide packet metadata and contents.
     * @type {string[]}
     */
    PACKET_PROPERTIES: ['packetUrl', 'packetContentUrl'],
   ...
   * telemetry.
   */
  CONSTANTS.CHANNEL_COPY_KEYS = CONSTANTS.CHANNEL_PROPERTIES.concat(
