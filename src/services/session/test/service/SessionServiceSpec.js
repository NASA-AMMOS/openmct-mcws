...
describe('SessionService', () => {
  ...
  beforeEach(() => {
    ...
    dataTable = jasmine.createSpyObj('dataTable', ['read']);
    ...
    sessionService.notifyUserOfHistoricalSessionFilterChange = jasmine.createSpy(
      'notifyUserOfHistoricalSessionFilterChange'
    );
  });
