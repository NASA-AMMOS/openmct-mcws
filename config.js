// TODO REPLACE URLS BEFORE OPEN SOURCING
(function () {
    const openmctMCWSConfig = {
        /**
         * camUrl: url to the CAM server this instance uses for auth.
         */
        camUrl: 'https://atb-ocio-12b.jpl.nasa.gov:8443/cam/UI/Login',
        /**
         * mcwsUrl: url for MCWS root.
         */
        mcwsUrl: 'https://uphill.jpl.nasa.gov/mcws',
        /**
        ...
        namespaces: [
            {
                key: 'r50-dev',
                name: 'R5.0 Shared',
                url: '/gov/nasa/jpl/mcs/project/ammos/dev/openmct/r50-dev/shared'
            },
            {
                userNamespace: true,
                key: 'r50-dev',
                name: 'R5.0 Users',
                url: '/gov/nasa/jpl/mcs/project/ammos/dev/openmct/r50-dev/users'
            }
        ],
